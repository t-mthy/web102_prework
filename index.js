...
function addGamesToPage(games) {
    ...
    for (const gameObj of games) {
        ...
        const dollarPledged = gameObj.pledged.toLocaleString('en-US', {style: 'currency', currency: 'USD'});
        const dollarGoal = gameObj.goal.toLocaleString('en-US', {style: 'currency', currency: 'USD'});
...
function filterUnfundedOnly() {
    ...
    const unfundedGamesArr = GAMES_JSON.filter(gameObj => gameObj.pledged < gameObj.goal);
...
function filterFundedOnly() {
    ...
    const fundedGamesArr = GAMES_JSON.filter(gameObj => gameObj.pledged >= gameObj.goal);
